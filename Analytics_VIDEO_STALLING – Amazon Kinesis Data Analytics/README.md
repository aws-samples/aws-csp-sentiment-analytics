The  SQL function "Analytics_VIDEO_STALLING" processes the input data stream in real-time and reports statistics and other relevant information to an output stream.
