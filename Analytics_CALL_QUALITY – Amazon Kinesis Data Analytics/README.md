# The  SQL function "Analytics_CALL_QUALITY" processes the input data stream in real-time and reports statistics and other relevant information to an output stream.
